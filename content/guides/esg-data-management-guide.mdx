...
faqs:
  - question: "Who needs to follow the ESG Data Management?"
    answer: "Define a comprehensive ESG data catalogue mapping every required metric to its source system, calculation methodology, responsible owner, and reporting destination."
  - question: "What is the first step in implementing ESG Data Management?"
    answer: "Our approach starts with a comprehensive data landscape assessment, identifying gaps, risks, and quick wins."
  - question: "How long does ESG Data Management implementation take?"
    answer: "Months 6–8: Implementation & Integration Deploy the platform, establish integrations with source systems, migrate historical data, and configure automated collection processes."
---
