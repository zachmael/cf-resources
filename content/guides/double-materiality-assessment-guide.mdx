...
faqs:
  - question: "Who needs to follow the Double Materiality Assessment?"
    answer: "The topics you determine to be material define the ESRS disclosures you must produce."
  - question: "What is the first step in implementing Double Materiality Assessment?"
    answer: "Double materiality is the foundational concept underpinning the EU's Corporate Sustainability Reporting Directive (CSRD) and the European Sustainability Reporting Standards (ESRS)."
  - question: "How long does Double Materiality Assessment implementation take?"
    answer: "Stakeholder Engagement Engage with affected stakeholders (employees, communities, customers, civil society) and users of sustainability information (investors, lenders, regulators) throughout the process."
---
