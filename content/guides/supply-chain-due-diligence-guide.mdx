...
faqs:
  - question: "Who needs to follow the Supply Chain Due Diligence?"
    answer: "The common thread across all these regulations is a shift from disclosure-only approaches to operational due diligence: companies must demonstrate that they have functioning systems to identify risks, take action, and track effectiveness."
  - question: "What is the first step in implementing Supply Chain Due Diligence?"
    answer: "Prepare first public due diligence report."
  - question: "How long does Supply Chain Due Diligence implementation take?"
    answer: "CSDDD was adopted in 2024 with a phased implementation timeline."
---
