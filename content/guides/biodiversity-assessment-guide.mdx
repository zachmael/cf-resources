...
faqs:
  - question: "Who needs to follow the Biodiversity Assessment?"
    answer: "Conduct a double materiality assessment covering both financial materiality (nature-related risks to the business) and impact materiality (the business's impacts on nature) as required by CSRD/ESRS."
  - question: "What is the first step in implementing Biodiversity Assessment?"
    answer: "Establish SMART biodiversity targets following SBTN's initial guidance for land and freshwater."
  - question: "How long does Biodiversity Assessment implementation take?"
    answer: "Months 1–3: Scoping & Location Analysis Map all operational sites, owned/leased land, and key supply chain sourcing regions."
---
