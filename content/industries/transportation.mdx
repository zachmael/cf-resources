...
faqs:
  - question: "What are the biggest sustainability challenges for transportation?"
    answer: "The infrastructure challenge is equally significant."
  - question: "What sustainability frameworks apply to transportation companies?"
    answer: "Use the Global Logistics Emissions Council (GLEC) Framework, which provides standardized methodologies for calculating logistics emissions across all modes."
  - question: "Where should transportation companies start with sustainability?"
    answer: "Start by mapping your major trade lanes and transportation modes, apply appropriate emission factors (ideally carrier-specific data, otherwise GLEC default factors), and allocate emissions based on weight, volume, or TEU as appropriate."
---
