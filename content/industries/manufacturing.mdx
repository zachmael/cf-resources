...
faqs:
  - question: "What are the biggest sustainability challenges for manufacturing?"
    answer: "The sector sits at the intersection of resource extraction, energy consumption, water use, and waste generation—making it one of the highest-impact areas for sustainability intervention."
  - question: "What sustainability frameworks apply to manufacturing companies?"
    answer: "Our team brings deep experience in GHG accounting across all three scopes, regulatory compliance planning, and ESG reporting aligned with CSRD, GRI, and SASB frameworks."
  - question: "Where should manufacturing companies start with sustainability?"
    answer: "We start with materiality assessments that identify the highest-impact intervention points—whether that's energy procurement, waste reduction, or supply chain engagement."
---
