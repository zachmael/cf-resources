...
faqs:
  - question: "What are the biggest sustainability challenges for energy?"
    answer: "For energy companies at every point in the value chain, the sustainability challenge is fundamentally a strategy challenge: how to navigate a multi-decade transition while maintaining financial viability and stakeholder confidence."
  - question: "What sustainability frameworks apply to energy companies?"
    answer: "Our team brings expertise in GHG accounting, methane management, carbon pricing exposure analysis, and ESG reporting for energy sector frameworks including SASB, GRI, and IPIECA."
  - question: "Where should energy companies start with sustainability?"
    answer: "A credible transition plan starts with an honest assessment of your portfolio's exposure to demand scenarios under various climate pathways (IEA NZE, NGFS scenarios)."
---
