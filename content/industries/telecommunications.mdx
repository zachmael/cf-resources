...
faqs:
  - question: "What are the biggest sustainability challenges for telecommunications?"
    answer: "The transition from 4G to 5G illustrates this challenge—5G is more energy-efficient per gigabyte but requires denser network deployments that increase total energy consumption."
  - question: "What sustainability frameworks apply to telecommunications companies?"
    answer: "For operators navigating CSRD reporting, SBTi target-setting, or enablement quantification, we provide methodological frameworks and implementation support."
  - question: "Where should telecommunications companies start with sustainability?"
    answer: "Start with a materiality assessment and greenhouse gas inventory to establish a baseline. This identifies which sustainability issues are most relevant to your operations and stakeholders."
---
