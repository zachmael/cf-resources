...
faqs:
  - question: "What is non-financial reporting?"
    answer: "Non-financial reporting is the disclosure of environmental, social, governance, and other sustainability information beyond traditional financial statements. The term is being replaced by 'sustainability reporting' as the distinction between financial and non-financial becomes blurred — many ESG factors are financially material."
  - question: "Is non-financial reporting mandatory?"
    answer: "In the EU, the CSRD replaces the earlier Non-Financial Reporting Directive (NFRD) with much more detailed requirements. Many jurisdictions now mandate some form of sustainability disclosure. The trend globally is toward mandatory, standardized sustainability reporting integrated with financial reporting."
  - question: "Why is the term 'non-financial reporting' falling out of use?"
    answer: "The term implies sustainability information is separate from financial performance. In practice, climate risk, human capital, and governance directly affect financial outcomes. The ISSB and CSRD both position sustainability information as decision-useful for investors, blurring the financial/non-financial distinction. 'Sustainability reporting' is now the preferred term."
