...
faqs:
  - question: "What is climate risk disclosure?"
    answer: "Climate risk disclosure is the reporting of climate-related risks and opportunities a company faces, including physical risks (extreme weather, sea-level rise) and transition risks (policy changes, technology shifts, market preferences). Major frameworks include TCFD, ISSB (IFRS S2), and CSRD/ESRS."
  - question: "Is climate risk disclosure mandatory?"
    answer: "Increasingly, yes. The EU requires it under CSRD/ESRS. The SEC finalized (then partially stayed) climate disclosure rules. California passed mandatory climate disclosure laws. The UK, Japan, Singapore, and other jurisdictions require or encourage TCFD-aligned reporting. The trend is toward global mandatory disclosure."
  - question: "What are physical vs. transition climate risks?"
    answer: "Physical risks are direct impacts of climate change — acute events (storms, floods, wildfires) and chronic shifts (rising temperatures, sea-level rise, water stress). Transition risks arise from the shift to a low-carbon economy — policy and regulatory changes, technology disruption, market shifts, and reputational impacts."
