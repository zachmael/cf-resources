...
faqs:
  - question: "What is a materiality assessment?"
    answer: "A materiality assessment is the process of identifying and prioritizing the ESG topics that are most significant for a company and its stakeholders. It determines which sustainability issues to focus on, report about, and manage — based on their importance to business performance and/or impact on people and the environment."
  - question: "What is the difference between single and double materiality assessments?"
    answer: "A single materiality assessment (ISSB approach) identifies sustainability issues that affect financial performance. A double materiality assessment (CSRD/GRI approach) also identifies issues where the company impacts people and the environment. Double materiality typically produces a broader set of material topics."
  - question: "How often should a company conduct a materiality assessment?"
    answer: "Best practice is to refresh the materiality assessment every 2-3 years or when significant changes occur in the business, regulatory environment, or stakeholder expectations. The CSRD requires ongoing monitoring of materiality, and stakeholder engagement should be a continuous process rather than a one-time exercise."
