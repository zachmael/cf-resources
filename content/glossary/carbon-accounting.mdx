...
faqs:
  - question: "What is carbon accounting?"
    answer: "Carbon accounting is the process of measuring, recording, and reporting an organization's greenhouse gas emissions. It follows standardized methodologies like the GHG Protocol to quantify emissions across Scope 1 (direct), Scope 2 (purchased energy), and Scope 3 (value chain) categories."
  - question: "Why is carbon accounting required?"
    answer: "Mandatory climate disclosure rules (CSRD, SEC Climate Rule, California climate laws) require auditable emissions data. Beyond compliance, carbon accounting identifies emission hotspots, tracks reduction progress, and supports science-based target setting."
  - question: "What tools are used for carbon accounting?"
    answer: "Companies use a mix of emissions factors databases (like DEFRA or EPA), activity data collection systems, and specialized software platforms (Watershed, Persefoni, Sphera) to calculate and manage their carbon inventories. Large companies typically require dedicated teams and third-party verification."
