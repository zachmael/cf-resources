...
faqs:
  - question: "What does it mean to tie executive compensation to ESG?"
    answer: "Tying executive compensation to ESG means linking a portion of executive pay (typically bonuses or long-term incentives) to measurable environmental, social, or governance targets. Common metrics include emission reduction targets, safety performance, diversity goals, and sustainability ratings."
  - question: "How common is ESG-linked executive pay?"
    answer: "As of 2025, over 70% of S&P 500 companies include some ESG metric in executive compensation plans, up from under 30% five years ago. European companies are even more likely to include ESG pay links. However, the rigor and weight of ESG components vary enormously."
  - question: "Does ESG-linked pay actually improve sustainability performance?"
    answer: "Evidence is mixed. Studies show ESG-linked pay correlates with improved disclosure and some performance metrics, but critics note that ESG targets are often too easy, lack materiality, or represent a small fraction of total pay. Effective design requires specific, measurable, material ESG targets with meaningful financial consequences."
