...
faqs:
  - question: "What are Scope 1 emissions?"
    answer: "Scope 1 emissions are direct greenhouse gas emissions from sources owned or controlled by a company. This includes emissions from burning fuel in company vehicles and boilers, on-site manufacturing processes, fugitive emissions from refrigerants, and any other emissions produced directly by company-owned assets."
  - question: "How are Scope 1 emissions calculated?"
    answer: "Scope 1 emissions are calculated by multiplying activity data (fuel consumed, gas leaked) by emission factors. For example, liters of diesel burned × the diesel emission factor = CO2e. Companies track fuel purchases, process emissions data, and refrigerant usage to compile their Scope 1 inventory."
  - question: "Why are Scope 1 emissions the easiest to reduce?"
    answer: "Scope 1 emissions are under a company's direct control, making them the most actionable. Reduction strategies include electrifying vehicle fleets, switching from gas to electric heating, upgrading equipment, fixing refrigerant leaks, and improving process efficiency. Most corporate decarbonization plans start with Scope 1."
