...
faqs:
  - question: "What is biodiversity?"
    answer: "Biodiversity is the variety of life on Earth at all levels — genetic diversity within species, species diversity within ecosystems, and ecosystem diversity across landscapes. It underpins the ecosystem services that human economies depend on, from pollination to water purification."
  - question: "Why is biodiversity loss a business risk?"
    answer: "Over half of global GDP ($44 trillion) depends on nature and ecosystem services. Biodiversity loss threatens agricultural productivity, supply chain stability, raw material availability, and access to genetic resources. Companies with nature-dependent operations face growing regulatory, physical, and transition risks."
  - question: "How are companies expected to report on biodiversity?"
    answer: "The Taskforce on Nature-related Financial Disclosures (TNFD) provides a framework for assessing and reporting nature-related risks and dependencies. The EU's CSRD also requires biodiversity disclosures under ESRS E4. Companies are expected to identify their impacts and dependencies on biodiversity across their value chains."
