...
faqs:
  - question: "What are greenhouse gas emissions?"
    answer: "Greenhouse gas emissions are gases released into the atmosphere that trap heat and drive global warming. The main greenhouse gases are carbon dioxide (CO2), methane (CH4), nitrous oxide (N2O), and fluorinated gases. CO2 from fossil fuel combustion accounts for roughly 75% of global greenhouse gas emissions."
  - question: "What is the difference between Scope 1, 2, and 3 emissions?"
    answer: "Scope 1 covers direct emissions from owned or controlled sources (fuel combustion, company vehicles). Scope 2 covers indirect emissions from purchased electricity, steam, heating, and cooling. Scope 3 covers all other indirect emissions across the value chain — typically 70-90% of a company's total footprint."
  - question: "How much do global greenhouse gas emissions need to fall?"
    answer: "To limit warming to 1.5°C, global emissions need to fall roughly 45% from 2010 levels by 2030 and reach net-zero by 2050. As of 2025, global emissions are still near record highs. The gap between current trajectories and required pathways is substantial and widening."
