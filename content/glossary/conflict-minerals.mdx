...
faqs:
  - question: "What are conflict minerals?"
    answer: "Conflict minerals are natural resources (tin, tantalum, tungsten, and gold — the '3TG') extracted in conflict zones where their trade finances armed groups and fuels human rights abuses. The term originated from mining in the Democratic Republic of Congo and surrounding regions."
  - question: "What regulations govern conflict minerals?"
    answer: "The U.S. Dodd-Frank Act (Section 1502) requires SEC-reporting companies to disclose use of 3TG minerals from conflict regions. The EU Conflict Minerals Regulation (effective 2021) requires importers of 3TG to conduct supply chain due diligence. Additional due diligence obligations apply under the EU's CS3D."
  - question: "How do companies address conflict minerals in supply chains?"
    answer: "Companies conduct supply chain mapping, require smelter-level due diligence using the Responsible Minerals Initiative's conformant smelter list, file Conflict Minerals Reports with the SEC, and engage with industry initiatives to promote responsible sourcing practices."
