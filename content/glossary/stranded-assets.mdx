...
faqs:
  - question: "What are stranded assets?"
    answer: "Stranded assets are investments that lose value prematurely due to the transition to a low-carbon economy. They include fossil fuel reserves that cannot be burned within carbon budgets, coal-fired power plants retired early, and infrastructure rendered obsolete by policy changes, technology shifts, or market forces."
  - question: "How much value could be stranded?"
    answer: "Carbon Tracker estimates that meeting climate targets could strand lastUpdated:-4 trillion in fossil fuel assets. The Bank of England has warned about 'vast' stranded asset risks in the financial system. Beyond fossil fuels, assets in carbon-intensive real estate, transportation, and manufacturing also face stranding risk."
  - question: "How does stranded asset risk affect investment decisions?"
    answer: "Investors increasingly evaluate portfolio exposure to stranding risk through climate scenario analysis. Banks assess loan book exposure to transition risk. Companies are expected to disclose stranded asset risks under TCFD and ISSB frameworks. The risk is driving capital reallocation from fossil fuels toward clean energy and climate-resilient assets."
