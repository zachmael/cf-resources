...
faqs:
  - question: "What is sustainability accounting?"
    answer: "Sustainability accounting is the measurement, analysis, and reporting of a company's environmental, social, and governance performance using standardized metrics. It extends traditional financial accounting to capture ESG impacts and risks, supporting both internal decision-making and external disclosure."
  - question: "How does sustainability accounting differ from financial accounting?"
    answer: "Financial accounting focuses on monetary transactions and financial position. Sustainability accounting measures non-financial performance (emissions, water use, workforce metrics) alongside financial impacts of ESG factors. The two are converging as sustainability issues are increasingly recognized as financially material."
  - question: "What standards govern sustainability accounting?"
    answer: "Key standards include SASB (industry-specific financial materiality), GRI (impact-focused), ISSB/IFRS S1-S2 (investor-focused sustainability disclosure), and ESRS (EU double materiality). The GHG Protocol governs emissions accounting specifically. Companies often report under multiple frameworks depending on their stakeholder audience."
