...
faqs:
  - question: "What is a social enterprise?"
    answer: "A social enterprise is a business that prioritizes social or environmental mission alongside financial sustainability. Revenue comes primarily from selling goods or services (not grants or donations), and profits are reinvested in the mission rather than maximizing shareholder returns."
  - question: "How are social enterprises different from nonprofits?"
    answer: "Social enterprises generate revenue through market-based activities rather than relying on grants and donations. They can be structured as for-profit or nonprofit entities. Unlike traditional nonprofits, they aim for financial self-sufficiency through business operations while pursuing social or environmental goals."
  - question: "What legal structures do social enterprises use?"
    answer: "Social enterprises operate under various legal forms including benefit corporations, Community Interest Companies (UK), L3C (low-profit LLC), cooperatives, and traditional LLCs or corporations with mission-protective governance provisions. The choice depends on jurisdiction, tax considerations, and investor requirements."
