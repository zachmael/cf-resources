...
faqs:
  - question: "What is the 1.5-degree pathway?"
    answer: "The 1.5-degree pathway is the emission reduction trajectory needed to limit global warming to 1.5°C above pre-industrial levels, as outlined in the Paris Agreement. It requires roughly 45% emission cuts by 2030 and net-zero CO2 by 2050."
  - question: "Is the 1.5-degree target still achievable?"
    answer: "Technically yes, but it requires unprecedented speed and scale of decarbonization. Most modeled pathways now assume temporary overshoot followed by net negative emissions to bring temperatures back down."
  - question: "What does the 1.5-degree pathway mean for businesses?"
    answer: "Companies setting science-based targets must now align with 1.5°C (the SBTi dropped the 2°C option in 2022). This means faster decarbonization timelines, greater investment in clean energy, and pressure from investors benchmarking portfolio alignment against 1.5°C scenarios."
