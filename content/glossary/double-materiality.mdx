...
faqs:
  - question: "What is double materiality?"
    answer: "Double materiality is an assessment approach that considers both how sustainability issues affect a company's financial performance (financial materiality) and how the company's activities impact people and the environment (impact materiality). It is the foundation of EU sustainability reporting under the CSRD."
  - question: "How is double materiality different from single materiality?"
    answer: "Single materiality (used by ISSB/SASB) focuses only on sustainability issues that affect enterprise value — the investor perspective. Double materiality adds the impact dimension — considering a company's effects on society and the environment regardless of whether they affect the company's own finances."
  - question: "Who requires double materiality assessments?"
    answer: "The EU's CSRD requires companies in scope to conduct double materiality assessments to determine which ESRS topics are material for their reporting. The GRI Standards also take a double materiality perspective. The ISSB currently uses single materiality but has signaled openness to convergence."
