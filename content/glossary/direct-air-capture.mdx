...
faqs:
  - question: "What is direct air capture?"
    answer: "Direct air capture (DAC) is a technology that chemically extracts CO2 directly from ambient air. The captured CO2 can be permanently stored underground (DACCS) or used in products. Unlike point-source capture, DAC can remove historical emissions from anywhere, regardless of where they were produced."
  - question: "How much does direct air capture cost?"
    answer: "Current costs range from $250-600 per ton of CO2, though leading companies like Climeworks and Carbon Engineering target lastUpdated:00-200/ton at scale. The US Department of Energy's 'Carbon Negative Shot' aims for below lastUpdated:00/ton. Costs are expected to decline with scale and technology improvements."
  - question: "Can direct air capture solve climate change?"
    answer: "DAC is necessary but not sufficient. Even optimistic projections foresee DAC removing only 5-10 billion tons of CO2 per year by 2050 — compared to 40+ billion tons emitted annually. It is meant for residual emissions that cannot be eliminated, not as a substitute for rapid decarbonization."
