...
faqs:
  - question: "What is biodiversity net gain?"
    answer: "Biodiversity net gain (BNG) is a policy requiring development projects to leave biodiversity in a measurably better state than before. In England, the Environment Act 2021 mandates a minimum 10% BNG for most new developments."
  - question: "How is biodiversity net gain measured?"
    answer: "BNG is measured using habitat condition assessments and biodiversity metrics (like England's Biodiversity Metric) that quantify habitat type, condition, and connectivity before and after development. The post-development score must exceed the pre-development baseline by the required percentage."
  - question: "Why does biodiversity net gain matter for real estate developers?"
    answer: "BNG is becoming a planning requirement in multiple jurisdictions. Developers must either achieve gains on-site, offset through off-site habitat creation, or purchase biodiversity credits. This affects project costs, timelines, and site selection decisions."
