...
faqs:
  - question: "What is CITES?"
    answer: "CITES (Convention on International Trade in Endangered Species) is an international agreement between 184 countries that regulates cross-border trade in wild animals and plants to ensure it does not threaten their survival. It covers about 40,000 species across three appendices with varying levels of trade restriction."
  - question: "How does CITES affect businesses?"
    answer: "Companies trading in timber, wildlife products, exotic leather, medicinal plants, or other biological resources must comply with CITES permit requirements. Non-compliance can result in shipment seizures, criminal penalties, and reputational damage. Supply chains involving natural materials should verify CITES compliance."
  - question: "What are the three CITES appendices?"
    answer: "Appendix I lists species threatened with extinction where commercial trade is banned. Appendix II covers species that could become threatened without trade controls, requiring export permits. Appendix III includes species protected in at least one country that has asked other CITES parties for assistance in controlling trade."
