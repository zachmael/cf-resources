...
faqs:
  - question: "What are ESG ratings?"
    answer: "ESG ratings are assessments of a company's environmental, social, and governance performance and risk exposure, produced by specialized agencies. Major providers include MSCI, Sustainalytics, S&P Global, ISS ESG, and CDP. Ratings inform investment decisions, benchmark performance, and influence capital allocation."
  - question: "Why do ESG ratings from different agencies disagree?"
    answer: "Ratings diverge because agencies measure different things (risk vs. impact), use different scopes (which issues are material), weight factors differently, and rely on different data sources. A company can be rated 'leader' by one agency and 'average' by another. This is a well-documented structural problem in the ESG ratings industry."
  - question: "How can companies improve their ESG ratings?"
    answer: "Companies can improve ratings by increasing disclosure transparency, aligning reporting with major frameworks (GRI, SASB, CDP), responding directly to rating agency questionnaires, implementing policies that address material ESG issues, and establishing clear governance structures for sustainability oversight."
