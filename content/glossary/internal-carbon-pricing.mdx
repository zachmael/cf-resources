...
faqs:
  - question: "What is internal carbon pricing?"
    answer: "Internal carbon pricing is a self-imposed cost on greenhouse gas emissions used within a company to guide investment decisions, drive emission reductions, and prepare for future carbon regulations. Common approaches include a shadow price (used in investment analysis) and an internal fee (actual charges to business units)."
  - question: "How much do companies charge per ton of carbon?"
    answer: "Internal carbon prices vary widely, from lastUpdated:0-15/ton at the low end to lastUpdated:50+/ton for companies using science-aligned pricing. Microsoft uses lastUpdated:5/ton, Novartis uses lastUpdated:00/ton, and some companies align with projected regulatory prices. CDP reports that over 2,000 companies use or plan to use internal carbon pricing."
  - question: "Does internal carbon pricing actually reduce emissions?"
    answer: "It depends on the design. Shadow prices that only inform analysis without financial consequences have less impact than internal fees that charge business units real money for emissions. The most effective programs combine meaningful price levels with revenue recycling into decarbonization projects."
