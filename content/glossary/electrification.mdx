...
faqs:
  - question: "What is electrification in the context of decarbonization?"
    answer: "Electrification means replacing fossil fuel-powered systems with electric alternatives — electric vehicles replacing combustion engines, heat pumps replacing gas boilers, electric arc furnaces replacing coal-fired steelmaking. When paired with clean electricity, electrification eliminates direct emissions from these end uses."
  - question: "Why is electrification central to net-zero?"
    answer: "Roughly 80% of global energy comes from fossil fuels burned directly in vehicles, buildings, and factories. Electrification allows these end uses to run on clean electricity from renewables and nuclear. The IEA estimates that electrification combined with clean power could deliver over 60% of emission reductions needed for net-zero."
  - question: "What are the barriers to electrification?"
    answer: "Key barriers include grid capacity (electricity demand could double or triple), upfront capital costs for equipment replacement, availability of critical minerals (lithium, cobalt, rare earths), workforce skills gaps, and the challenge of electrifying hard-to-abate sectors where direct electrification isn't technically feasible."
