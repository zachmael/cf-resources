...
faqs:
  - question: "What is cradle to cradle?"
    answer: "Cradle to Cradle (C2C) is a design framework that models human industry on nature's processes, where all materials are nutrients that cycle continuously. Products are designed so their components can be safely returned to either biological cycles (compostable) or technical cycles (recyclable) with no waste."
  - question: "How does cradle to cradle differ from recycling?"
    answer: "Traditional recycling often 'downcycles' materials into lower-quality products. C2C designs materials to maintain their quality through infinite use cycles. It eliminates the concept of waste by ensuring every material component is intentionally designed for safe biological or technical cycling."
  - question: "What is Cradle to Cradle certification?"
    answer: "The Cradle to Cradle Certified Products Program evaluates products across five categories: material health, material reutilization, renewable energy and carbon management, water stewardship, and social fairness. Products are certified at Bronze, Silver, Gold, or Platinum levels."
