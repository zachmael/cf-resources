...
faqs:
  - question: "What is integrated reporting?"
    answer: "Integrated reporting combines financial and non-financial information into a single report that shows how an organization creates value over time across six capitals: financial, manufactured, intellectual, human, social/relationship, and natural. The International Integrated Reporting Framework was developed by the IIRC (now part of the IFRS Foundation)."
  - question: "How does integrated reporting differ from sustainability reporting?"
    answer: "Sustainability reports focus on ESG performance and impacts. Integrated reports show the connections between sustainability factors and financial value creation, providing a holistic view of how a company uses and affects all forms of capital. The goal is to break down the silos between financial and sustainability information."
  - question: "Is integrated reporting still relevant?"
    answer: "Yes, though the landscape has evolved. The IIRC merged into the IFRS Foundation in 2022, and integrated thinking underpins the ISSB standards. The CSRD's management report approach also reflects integrated reporting principles. The concept of connecting sustainability to value creation remains central to modern corporate reporting."
