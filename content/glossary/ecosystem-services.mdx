...
faqs:
  - question: "What are ecosystem services?"
    answer: "Ecosystem services are the benefits that nature provides to people, including provisioning services (food, water, timber), regulating services (climate regulation, flood control, pollination), cultural services (recreation, spiritual value), and supporting services (nutrient cycling, soil formation)."
  - question: "How much are ecosystem services worth?"
    answer: "Global ecosystem services have been valued at lastUpdated:25-145 trillion per year — roughly 1.5 times global GDP. This valuation, while contested methodologically, illustrates the economic dependence of human systems on natural capital. The annual loss of ecosystem services due to land degradation alone is estimated at $6-10 trillion."
  - question: "How do businesses account for ecosystem services?"
    answer: "Companies use frameworks like the Natural Capital Protocol, TNFD, and corporate ecosystem valuation to assess dependencies and impacts on ecosystem services. This informs risk management, site selection, supply chain strategy, and disclosure. The EU taxonomy and CSRD also require consideration of ecosystem impacts."
