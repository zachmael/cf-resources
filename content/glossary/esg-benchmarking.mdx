...
faqs:
  - question: "What is ESG benchmarking?"
    answer: "ESG benchmarking is the practice of comparing a company's environmental, social, and governance performance against peers, industry standards, or best-in-class leaders. It uses ESG ratings, disclosure scores, and performance metrics to identify gaps and track relative progress."
  - question: "What are the main ESG benchmarking sources?"
    answer: "Major sources include MSCI ESG Ratings, Sustainalytics, CDP scores, ISS ESG, S&P Global CSA, and Bloomberg ESG Data. Each uses different methodologies, which is why the same company can receive widely different ESG scores from different providers."
  - question: "Why do ESG ratings disagree?"
    answer: "ESG rating divergence occurs because providers measure different things, weight factors differently, and use different data sources. MIT research found only a 0.54 correlation between major ESG raters — compared to 0.92 for credit ratings. This makes it important to understand each provider's methodology rather than relying on a single score."
