...
faqs:
  - question: "What is the GHG Protocol?"
    answer: "The GHG Protocol is the most widely used international standard for measuring and managing greenhouse gas emissions. Developed by the World Resources Institute and WBCSD, it defines the three-scope framework (Scope 1, 2, 3) and provides detailed accounting guidance used by over 90% of Fortune 500 companies that report emissions."
  - question: "What are the main GHG Protocol standards?"
    answer: "The GHG Protocol includes the Corporate Standard (Scope 1 and 2), the Corporate Value Chain Standard (Scope 3), the Product Standard (product-level footprints), and the Project Protocol (emission reduction quantification). The Land Sector and Removals Guidance, released in 2024, addresses carbon removals and land use."
  - question: "Is the GHG Protocol being updated?"
    answer: "The GHG Protocol is undergoing a review and update process. Key issues include improving Scope 2 market-based accounting guidance, clarifying Scope 3 boundary-setting, addressing carbon removal accounting, and aligning with mandatory disclosure requirements like CSRD and ISSB."
