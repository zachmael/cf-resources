...
faqs:
  - question: "What is the waste hierarchy?"
    answer: "The waste hierarchy ranks waste management options from most to least preferred: prevention (avoid creating waste), reuse, recycling, recovery (energy from waste), and disposal (landfill). It guides policy and corporate waste strategies by prioritizing upstream solutions over end-of-pipe treatment."
  - question: "How does the waste hierarchy guide business decisions?"
    answer: "The hierarchy encourages companies to first reduce waste at the source through product and process redesign, then maximize reuse and recycling, and only resort to energy recovery and disposal as last options. EU waste legislation and many corporate zero-waste programs are structured around the hierarchy."
  - question: "Is energy recovery better than recycling?"
    answer: "No — the waste hierarchy places recycling above energy recovery because recycling preserves material value and avoids the environmental costs of extracting and processing virgin resources. Energy recovery destroys materials permanently. However, for some contaminated or mixed waste streams where recycling is not feasible, energy recovery is preferable to landfill."
