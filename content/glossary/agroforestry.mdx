...
faqs:
  - question: "What is agroforestry?"
    answer: "Agroforestry is a land management practice that integrates trees and shrubs with crops or livestock on the same land. It combines agricultural production with environmental benefits like carbon sequestration, soil health, and biodiversity."
  - question: "How does agroforestry help with climate change?"
    answer: "Agroforestry sequesters carbon in tree biomass and soil, reduces erosion, improves water retention, and can lower the need for synthetic fertilizers. Well-designed systems can store 2-10 times more carbon than conventional agriculture."
  - question: "Why are companies investing in agroforestry?"
    answer: "Companies with agricultural supply chains use agroforestry to reduce Scope 3 emissions, build supply chain resilience against climate impacts, and meet deforestation-free sourcing commitments. It also supports biodiversity targets increasingly required under frameworks like TNFD."
