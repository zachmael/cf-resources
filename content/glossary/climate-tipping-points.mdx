...
faqs:
  - question: "What are climate tipping points?"
    answer: "Climate tipping points are thresholds beyond which small changes trigger large, often irreversible shifts in Earth's climate system. Examples include the collapse of ice sheets, Amazon rainforest dieback, permafrost thawing, and disruption of ocean circulation patterns like the Atlantic Meridional Overturning Circulation."
  - question: "At what temperature do tipping points occur?"
    answer: "Research published in Science (2022) identified that several tipping points become likely between 1.5°C and 2°C of warming, including Greenland ice sheet collapse, West Antarctic ice sheet collapse, tropical coral reef die-off, and permafrost abrupt thawing. Additional tipping points become probable above 2°C."
  - question: "How do tipping points affect financial risk?"
    answer: "Tipping points create non-linear, potentially catastrophic risks that standard financial models struggle to capture. They could trigger cascading impacts across agriculture, real estate, insurance, and infrastructure. Central banks and financial regulators increasingly recognize tipping points as systemic risks to financial stability."
