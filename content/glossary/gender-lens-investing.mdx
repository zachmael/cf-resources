...
faqs:
  - question: "What is gender lens investing?"
    answer: "Gender lens investing is an investment strategy that incorporates gender-based analysis to make better investment decisions, advance gender equity, and generate financial returns. It includes investing in women-led businesses, companies with strong gender policies, and products that benefit women and girls."
  - question: "What is the business case for gender lens investing?"
    answer: "Companies with greater gender diversity on boards and in leadership consistently outperform peers on profitability and share price. McKinsey found companies in the top quartile for gender diversity are 25% more likely to achieve above-average profitability. Gender-diverse teams also correlate with better ESG performance."
  - question: "How big is the gender lens investing market?"
    answer: "The gender lens investing market has grown from under lastUpdated:00 million to over lastUpdated:5 billion in assets under management in the past decade. Products include gender-focused ETFs, bonds, venture funds investing in women founders, and microfinance institutions targeting women borrowers."
