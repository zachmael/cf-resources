...
faqs:
  - question: "What are Scope 2 emissions?"
    answer: "Scope 2 emissions are indirect greenhouse gas emissions from the generation of purchased electricity, steam, heating, and cooling consumed by a company. They are the second-largest emission source for most companies and are reduced by purchasing renewable energy, improving energy efficiency, and on-site generation."
  - question: "What is the difference between location-based and market-based Scope 2?"
    answer: "Location-based Scope 2 uses average grid emission factors reflecting the actual energy mix where electricity is consumed. Market-based Scope 2 uses emission factors from contractual instruments like RECs, PPAs, or green tariffs. A company can report zero market-based Scope 2 by purchasing enough RECs while its location-based figure remains unchanged."
  - question: "How do companies reduce Scope 2 emissions?"
    answer: "Primary strategies include purchasing renewable electricity through PPAs or green tariffs, installing on-site solar or wind, buying renewable energy certificates, improving energy efficiency to reduce total consumption, and participating in programs like RE100 that commit to 100% renewable electricity."
