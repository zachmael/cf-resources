...
faqs:
  - question: "What is decarbonization?"
    answer: "Decarbonization is the process of reducing carbon dioxide and other greenhouse gas emissions from economic activities. It involves shifting energy systems from fossil fuels to renewables, electrifying transport and heating, improving industrial efficiency, and deploying carbon removal for residual emissions."
  - question: "Which sectors are hardest to decarbonize?"
    answer: "Heavy industry (steel, cement, chemicals), long-haul transport (aviation, shipping), and agriculture are considered 'hard-to-abate' sectors. They require technologies still at early stages — green hydrogen, sustainable aviation fuel, carbon capture — or fundamental process changes that are capital-intensive and slow to deploy."
  - question: "What does a corporate decarbonization plan look like?"
    answer: "A credible plan starts with a full GHG inventory, sets science-based targets (typically 4.2% annual reduction for 1.5°C alignment), identifies abatement levers by source, allocates capital and resources, establishes interim milestones, and reports progress transparently. Plans without capital allocation and governance are not credible."
