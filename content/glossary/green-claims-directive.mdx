...
faqs:
  - question: "What is the Green Claims Directive?"
    answer: "The EU Green Claims Directive is proposed legislation requiring companies to substantiate environmental marketing claims with scientific evidence and third-party verification before communicating them to consumers. It targets vague claims like 'eco-friendly,' 'natural,' or 'climate neutral' that lack supporting evidence."
  - question: "What claims does the directive cover?"
    answer: "The directive covers explicit environmental claims (statements about environmental performance) and environmental labels (logos or symbols suggesting environmental qualities). It requires claims to be based on recognized scientific evidence, cover the full lifecycle, specify whether they apply to the entire product or only parts, and be verified by an independent body."
  - question: "How will the Green Claims Directive affect marketing?"
    answer: "Companies will need to substantiate all environmental claims before use, fund independent verification, and avoid generic claims without specific evidence. Claims based solely on carbon offsetting will face restrictions. Non-compliance could result in fines, product bans, and exclusion from public procurement."
