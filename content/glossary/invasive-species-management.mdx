...
faqs:
  - question: "What are invasive species?"
    answer: "Invasive species are non-native organisms introduced to an ecosystem where they cause ecological or economic harm. They can outcompete native species, alter habitats, spread diseases, and damage infrastructure. The global economic cost of invasive species exceeds $423 billion annually."
  - question: "How do invasive species relate to ESG?"
    answer: "Companies in agriculture, forestry, shipping, aquaculture, and real estate can both introduce and be affected by invasive species. Supply chain activities can transport invasive organisms across borders. Biodiversity frameworks like TNFD expect companies to assess and manage their invasive species risks and impacts."
  - question: "What are common invasive species management approaches?"
    answer: "Management approaches include prevention (biosecurity measures, ballast water treatment), early detection and rapid response, physical removal, biological control (introducing natural predators), chemical treatment, and habitat restoration to improve ecosystem resistance to invasion."
