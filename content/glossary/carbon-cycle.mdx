...
faqs:
  - question: "What is the carbon cycle?"
    answer: "The carbon cycle is the natural process by which carbon moves between the atmosphere, oceans, soil, rocks, and living organisms. It includes processes like photosynthesis, respiration, decomposition, ocean absorption, and volcanic emissions that have kept atmospheric CO2 relatively stable for millennia."
  - question: "How have humans disrupted the carbon cycle?"
    answer: "Burning fossil fuels releases carbon that was locked underground for millions of years, adding roughly 40 billion tons of CO2 to the atmosphere annually. Deforestation reduces the land's capacity to absorb CO2. The result is a 50% increase in atmospheric CO2 since pre-industrial times."
  - question: "Why does the carbon cycle matter for sustainability?"
    answer: "Understanding the carbon cycle is fundamental to climate strategy. It explains why some carbon removal approaches (like reforestation) are temporary while geological storage is permanent, why ocean carbon sinks are weakening, and why reducing fossil fuel extraction is different from managing biogenic carbon flows."
