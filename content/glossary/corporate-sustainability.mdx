...
faqs:
  - question: "What is corporate sustainability?"
    answer: "Corporate sustainability is a business approach that creates long-term value by integrating environmental, social, and governance considerations into company strategy and operations. It goes beyond compliance to embed sustainability into business models, supply chains, and decision-making."
  - question: "How is corporate sustainability measured?"
    answer: "It is measured through ESG ratings, sustainability reports (aligned with GRI, SASB, ISSB), carbon inventories, third-party certifications (B Corp, ISO 14001), and performance against voluntary commitments like science-based targets, RE100, or the UN Global Compact."
  - question: "What drives corporate sustainability adoption?"
    answer: "Key drivers include regulatory requirements (CSRD, SEC rules), investor pressure (ESG integration, shareholder resolutions), customer expectations, employee recruitment and retention, risk management, cost savings from efficiency, and competitive positioning in markets increasingly shaped by sustainability performance."
