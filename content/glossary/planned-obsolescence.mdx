...
faqs:
  - question: "What is planned obsolescence?"
    answer: "Planned obsolescence is the deliberate design of products with a limited useful life to encourage replacement purchases. It takes forms including technical obsolescence (products fail prematurely), functional obsolescence (new features make old products undesirable), and systemic obsolescence (software updates degrade older hardware)."
  - question: "How is regulation addressing planned obsolescence?"
    answer: "The EU's Ecodesign for Sustainable Products Regulation, Right to Repair Directive, and France's Repairability Index directly target planned obsolescence. France made planned obsolescence a criminal offense in 2015 (fines up to €300,000 and 2 years imprisonment). The EU requires manufacturers to provide spare parts and repair information."
  - question: "What is the environmental impact of planned obsolescence?"
    answer: "Planned obsolescence drives overconsumption of resources and generates massive waste streams — particularly e-waste. It increases greenhouse gas emissions from manufacturing replacement products, depletes scarce materials, and contributes to landfill pollution. Extending product lifespans by just one year can significantly reduce lifecycle environmental impacts."
