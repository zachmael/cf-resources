...
faqs:
  - question: "What is the SEC Climate Rule?"
    answer: "The SEC's climate disclosure rule (adopted March 2024) requires publicly traded companies in the US to disclose material climate-related risks, governance, targets, Scope 1 and 2 emissions (for large filers), and financial impacts of climate events. It was partially stayed pending legal challenges."
  - question: "What is the current status of the SEC Climate Rule?"
    answer: "The rule faces legal challenges from both industry groups (arguing it overreaches) and environmental organizations (arguing it doesn't go far enough). The SEC voluntarily stayed parts of the rule in April 2024 pending litigation. The final scope and implementation timeline remain uncertain."
  - question: "What does the SEC Climate Rule require?"
    answer: "The rule requires disclosure of climate-related risks, governance and risk management processes, scenario analysis if used, GHG emissions (Scope 1 and 2 for large accelerated and accelerated filers), climate-related targets and transition plans, and financial statement footnotes for material climate impacts. Scope 3 was dropped from the final rule."
