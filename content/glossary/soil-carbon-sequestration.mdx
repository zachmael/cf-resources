...
faqs:
  - question: "What is soil carbon sequestration?"
    answer: "Soil carbon sequestration is the process of capturing atmospheric CO2 and storing it in soil organic matter through practices like cover cropping, reduced tillage, composting, and agroforestry. Soils hold roughly 2,500 gigatons of carbon — more than three times the amount in the atmosphere."
  - question: "How much carbon can soil sequester?"
    answer: "Estimates vary, but improved soil management could sequester 1-3 gigatons of CO2 per year globally — roughly 3-8% of annual emissions. Individual farm-level sequestration rates depend on soil type, climate, prior management, and practices adopted. Sequestration rates are highest in the first 10-20 years of improved management."
  - question: "Can soil carbon credits be reliable?"
    answer: "Soil carbon credits face challenges around measurement uncertainty (soil carbon varies significantly across small areas), permanence (carbon can be re-released if practices change), and additionality. Verification requires repeated soil sampling or modeling. Protocols from Verra and Gold Standard are working to address these challenges but the science is still maturing."
