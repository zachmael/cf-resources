...
faqs:
  - question: "What are Scope 3 supply chain emissions?"
    answer: "Scope 3 supply chain emissions are indirect greenhouse gas emissions occurring in a company's value chain — both upstream (purchased goods, transportation, employee commuting) and downstream (product use, end-of-life treatment). They typically represent 70-90% of a company's total carbon footprint."
  - question: "Why are Scope 3 emissions so hard to measure?"
    answer: "Scope 3 requires data from hundreds or thousands of suppliers and customers, many of whom don't track their own emissions. Companies often rely on spend-based estimates (emissions per dollar spent) rather than actual activity data, resulting in significant uncertainty. Data quality is the biggest challenge in Scope 3 accounting."
  - question: "How are companies tackling Scope 3 emissions?"
    answer: "Companies use supplier engagement programs, industry partnerships, procurement policies favoring low-carbon suppliers, product redesign to reduce lifecycle emissions, and investment in supply chain decarbonization. CDP Supply Chain and SBTi requirements are driving more systematic Scope 3 reduction efforts."
