...
faqs:
  - question: "What is a product lifecycle assessment?"
    answer: "A product lifecycle assessment (LCA) evaluates the environmental impacts of a product across its entire life — from raw material extraction, through manufacturing, distribution, and use, to end-of-life disposal or recycling. It is standardized under ISO 14040 and ISO 14044."
  - question: "What environmental impacts does an LCA measure?"
    answer: "LCAs typically assess climate change (carbon footprint), ozone depletion, acidification, eutrophication, resource depletion, water use, land use, and toxicity. The scope depends on the goal — a carbon-focused LCA may only measure greenhouse gas emissions, while a full LCA covers all impact categories."
  - question: "Why do companies conduct LCAs?"
    answer: "LCAs inform product design decisions, identify environmental hotspots in the value chain, support environmental product declarations (EPDs), substantiate green marketing claims, and help meet regulatory requirements like the EU's Product Environmental Footprint (PEF) methodology."
