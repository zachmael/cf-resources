...
faqs:
  - question: "What is climate modeling?"
    answer: "Climate modeling uses mathematical simulations to represent Earth's climate system — atmosphere, oceans, land surface, and ice — and project how it will change under different emission scenarios. Models are run on supercomputers and form the basis of IPCC projections."
  - question: "How accurate are climate models?"
    answer: "Climate models have proven remarkably accurate at projecting long-term global temperature trends. Models from the 1990s correctly predicted the warming observed over the following decades. They are less precise at regional scales and for specific weather patterns, but continue to improve."
  - question: "How do businesses use climate models?"
    answer: "Companies use climate model outputs for scenario analysis (as recommended by TCFD/ISSB), physical risk assessment of assets and supply chains, long-term strategic planning, and insurance pricing. The most commonly used scenarios are the IPCC's Shared Socioeconomic Pathways (SSPs)."
