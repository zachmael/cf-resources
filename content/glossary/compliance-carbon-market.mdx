...
faqs:
  - question: "What is a compliance carbon market?"
    answer: "A compliance carbon market is a government-mandated system where regulated entities must hold emission allowances equal to their greenhouse gas output. Companies that emit less than their allocation can sell surplus allowances; those that exceed it must buy more. The EU ETS is the largest example."
  - question: "How do compliance carbon markets differ from voluntary markets?"
    answer: "Compliance markets are mandatory, government-regulated, and cover specific sectors with enforceable caps. Voluntary carbon markets are optional, self-regulated, and rely on companies choosing to offset emissions. Compliance market prices are typically higher and more stable due to regulatory enforcement."
  - question: "What carbon prices exist in compliance markets?"
    answer: "As of 2025, EU ETS allowances trade around €65-80 per ton of CO2. California's cap-and-trade system runs around $30-40/ton. China's national ETS is much lower at roughly lastUpdated:0/ton. Prices are expected to rise as caps tighten in pursuit of net-zero targets."
