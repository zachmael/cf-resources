...
faqs:
  - question: "What are indigenous rights in the sustainability context?"
    answer: "Indigenous rights in sustainability encompass land and resource rights, free prior and informed consent (FPIC), cultural preservation, traditional knowledge protection, and equitable benefit-sharing. Indigenous peoples manage roughly 25% of Earth's land surface and 80% of remaining biodiversity."
  - question: "What is free, prior and informed consent (FPIC)?"
    answer: "FPIC is the right of indigenous peoples to give or withhold consent to projects affecting their lands, territories, or resources. It must be free (no coercion), prior (before activities begin), and informed (with full project information). It is recognized in the UN Declaration on the Rights of Indigenous Peoples and required by IFC Performance Standards."
  - question: "How do companies address indigenous rights?"
    answer: "Companies are expected to conduct FPIC processes, develop indigenous engagement plans, respect land rights and cultural heritage, share benefits equitably, establish grievance mechanisms, and ensure supply chains do not contribute to violations of indigenous rights. ESRS S3 and IFC PS7 provide reporting frameworks."
