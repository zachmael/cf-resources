...
faqs:
  - question: "What counts as an extreme weather event?"
    answer: "Extreme weather events are meteorological phenomena that are significantly above or below normal ranges — including heatwaves, hurricanes, floods, droughts, wildfires, and severe storms. Climate change is making many of these events more frequent, intense, or both."
  - question: "How much do extreme weather events cost?"
    answer: "Global insured losses from natural catastrophes exceeded lastUpdated:00 billion annually in recent years, with total economic losses roughly double that. In the US alone, billion-dollar weather disasters have averaged 20+ events per year since 2020, compared to roughly 8 per year in the 2000s."
  - question: "How should companies prepare for extreme weather?"
    answer: "Companies should conduct physical climate risk assessments of their assets and supply chains, develop business continuity plans for climate scenarios, invest in infrastructure hardening, diversify supply chains geographically, secure adequate insurance, and engage in industry and community resilience initiatives."
