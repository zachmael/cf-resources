...
faqs:
  - question: "What is an inclusive economy?"
    answer: "An inclusive economy is one where economic growth and opportunity are broadly shared across all segments of society, including historically marginalized groups. It emphasizes equitable access to jobs, education, healthcare, housing, and financial services rather than just aggregate GDP growth."
  - question: "How does the inclusive economy relate to ESG?"
    answer: "The social dimension of ESG increasingly focuses on whether companies contribute to or hinder economic inclusion. Metrics include living wages, workforce diversity, community investment, supplier diversity, and access to products and services for underserved populations. Inclusive economy principles inform social impact assessment and reporting."
  - question: "Why do businesses benefit from inclusive economic practices?"
    answer: "Inclusive practices expand customer bases, strengthen community relationships, improve employee recruitment and retention, reduce regulatory and reputational risk, and build social license to operate. Research shows economies with greater inclusion grow faster and more sustainably than those with high inequality."
