...
faqs:
  - question: "What does net-zero mean?"
    answer: "Net-zero means reducing greenhouse gas emissions as close to zero as possible, with any remaining emissions balanced by an equivalent amount of carbon removal. The Science Based Targets initiative (SBTi) requires at least 90% absolute emission reductions before using removals for the residual."
  - question: "How many companies have net-zero targets?"
    answer: "Over 7,000 companies have committed to net-zero through the SBTi as of 2025, covering a significant share of global market capitalization. However, analysis shows that many corporate net-zero pledges lack credible implementation plans, interim targets, and capital allocation to deliver on their commitments."
  - question: "What is the difference between net-zero and carbon neutral?"
    answer: "Carbon neutral allows unlimited use of offsets to balance emissions. Net-zero requires deep decarbonization (90%+ reduction) first, using removals only for residual emissions. Net-zero typically covers all greenhouse gases, while carbon neutral often covers only CO2. Net-zero is the more scientifically rigorous standard."
