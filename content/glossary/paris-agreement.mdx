...
faqs:
  - question: "What is the Paris Agreement?"
    answer: "The Paris Agreement is a 2015 international treaty adopted by 196 countries at COP21 to limit global warming to well below 2°C, preferably 1.5°C, above pre-industrial levels. Countries submit nationally determined contributions (NDCs) with emission reduction pledges, updated every five years with increasing ambition."
  - question: "Is the Paris Agreement legally binding?"
    answer: "The Paris Agreement is legally binding in that countries must submit and update NDCs and report on progress. However, the specific emission reduction targets within NDCs are nationally determined and self-enforced — there are no penalties for failing to meet them. The US withdrew under Trump and rejoined under Biden."
  - question: "How does the Paris Agreement affect businesses?"
    answer: "The Paris Agreement drives national climate policies that directly affect businesses — carbon pricing, emission standards, energy regulations, and disclosure requirements. It also established the benchmark for corporate climate targets; the 1.5°C goal is the reference point for science-based targets, transition planning, and investor expectations."
