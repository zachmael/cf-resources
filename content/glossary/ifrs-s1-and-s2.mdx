...
faqs:
  - question: "What are IFRS S1 and S2?"
    answer: "IFRS S1 (General Requirements) and S2 (Climate-related Disclosures) are sustainability disclosure standards issued by the International Sustainability Standards Board (ISSB). S1 sets the framework for sustainability-related financial disclosures; S2 specifically addresses climate risks, opportunities, and emissions reporting."
  - question: "How do IFRS S1 and S2 relate to TCFD?"
    answer: "IFRS S2 fully incorporates the TCFD recommendations, which were sunset in 2024 as the ISSB took over. Companies already reporting under TCFD are substantially aligned with S2. The four-pillar structure (governance, strategy, risk management, metrics/targets) is the same."
  - question: "Which countries are adopting IFRS S1 and S2?"
    answer: "As of 2025, jurisdictions including the UK, Japan, Singapore, Australia, Canada, Nigeria, and others have announced plans to adopt or base national standards on ISSB requirements. Adoption timelines and scope vary by jurisdiction. The EU uses its own ESRS standards but has committed to interoperability with ISSB."
