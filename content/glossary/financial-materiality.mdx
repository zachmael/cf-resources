...
faqs:
  - question: "What is financial materiality in ESG?"
    answer: "Financial materiality identifies sustainability issues that could reasonably affect a company's financial performance, cash flows, or enterprise value. It is the lens used by ISSB, SASB, and the TCFD — focused on what matters to investors rather than on the company's impact on the world."
  - question: "How is financial materiality determined?"
    answer: "Companies assess financial materiality by evaluating whether sustainability issues create risks or opportunities that could affect revenue, costs, assets, liabilities, or cost of capital. This involves analyzing regulatory trends, market shifts, physical risks, technology changes, and stakeholder expectations that translate into financial effects."
  - question: "How does financial materiality differ from impact materiality?"
    answer: "Financial materiality asks: 'How does this sustainability issue affect our business?' Impact materiality asks: 'How does our business affect the world?' The ISSB uses financial materiality alone. The EU's CSRD requires both (double materiality). The distinction determines the scope of what companies must report."
