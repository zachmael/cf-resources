...
faqs:
  - question: "What are deforestation-free supply chains?"
    answer: "Deforestation-free supply chains ensure that commodities like soy, palm oil, cocoa, coffee, beef, rubber, and timber are produced without converting forests. Companies verify this through traceability systems, satellite monitoring, supplier certifications, and cut-off dates after which no deforestation is acceptable."
  - question: "What regulations require deforestation-free sourcing?"
    answer: "The EU Deforestation Regulation (EUDR) requires companies placing specific commodities on the EU market to prove they are deforestation-free (using a December 2020 cut-off date). The UK Environment Act includes similar provisions. Corporate commitments through the Consumer Goods Forum also drive adoption."
  - question: "How do companies verify deforestation-free claims?"
    answer: "Verification uses a combination of GPS-level farm mapping, satellite imagery analysis, supply chain traceability platforms, third-party certification schemes (RSPO, Rainforest Alliance), and geolocation data matching. The EUDR specifically requires geolocation coordinates for all production plots."
