...
faqs:
  - question: "What is a carbon tax?"
    answer: "A carbon tax is a fee levied on the carbon content of fossil fuels or on direct greenhouse gas emissions. Unlike cap-and-trade, it sets a fixed price per ton of CO2 rather than capping total emissions. It provides price certainty but not emission quantity certainty."
  - question: "Which countries have a carbon tax?"
    answer: "Over 30 countries have implemented carbon taxes, including Canada, Sweden, Norway, Finland, Switzerland, South Africa, and Colombia. Rates vary widely — from under $5/ton in some countries to over lastUpdated:30/ton in Sweden, which has one of the highest carbon tax rates globally."
  - question: "What happens to carbon tax revenue?"
    answer: "Governments use carbon tax revenue differently: some return it to citizens as dividends (Canada's approach), some fund clean energy investments, some reduce other taxes to maintain revenue neutrality, and some direct it to general government spending. Revenue recycling design significantly affects public acceptance."
