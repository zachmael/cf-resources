...
faqs:
  - question: "What is the right to repair?"
    answer: "The right to repair is the principle that consumers and independent repair shops should have access to the parts, tools, manuals, and software needed to fix products they own. It challenges manufacturer restrictions that force consumers to use authorized repair services or replace products entirely."
  - question: "What right-to-repair laws exist?"
    answer: "The EU adopted a Right to Repair Directive in 2024 covering household appliances, electronics, and other products. Multiple US states have passed right-to-repair laws, particularly for electronics and agricultural equipment. France requires repairability scores on electronics. The trend is toward broader product coverage and stronger requirements."
  - question: "How does right to repair relate to sustainability?"
    answer: "Extending product lifespans through repair reduces resource extraction, manufacturing emissions, and waste. The EU estimates that better repairability could save 18.5 million tons of CO2 annually and reduce 6.5 million tons of waste. It directly supports circular economy goals and reduces consumer costs."
