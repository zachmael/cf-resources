...
faqs:
  - question: "What is the TCFD?"
    answer: "The Task Force on Climate-related Financial Disclosures (TCFD) was established by the Financial Stability Board in 2015 to develop recommendations for climate risk disclosure. It created the four-pillar framework — governance, strategy, risk management, metrics and targets — now embedded in the ISSB standards and most climate disclosure regulations."
  - question: "Is TCFD still relevant after the ISSB?"
    answer: "The TCFD formally disbanded in 2024, with its monitoring responsibilities transferred to the ISSB. However, its framework lives on — IFRS S2 fully incorporates the TCFD recommendations. Companies that have been reporting under TCFD are substantially compliant with the climate portions of ISSB standards."
  - question: "What is scenario analysis under the TCFD?"
    answer: "TCFD scenario analysis requires companies to assess how their strategy and financial position would be affected under different climate futures — typically a 1.5°C orderly transition, a 2-3°C disorderly transition, and a 4°C+ physical risk scenario. It helps companies identify risks and opportunities across a range of plausible futures."
