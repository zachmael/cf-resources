...
faqs:
  - question: "What is fisheries sustainability?"
    answer: "Fisheries sustainability means harvesting fish at rates that maintain healthy populations, preserve marine ecosystems, and ensure long-term food supply. It involves science-based catch limits, ecosystem-based management, reduction of bycatch, and protection of spawning habitats."
  - question: "How bad is overfishing?"
    answer: "The FAO estimates that about 35% of global fish stocks are overfished — harvested at biologically unsustainable levels. Another 57% are fully fished with no room for expansion. Overfishing has reduced large predatory fish populations by 90% since 1950 in some ocean basins."
  - question: "How do businesses ensure sustainable seafood sourcing?"
    answer: "Companies use certifications like MSC (Marine Stewardship Council) for wild-caught fish and ASC (Aquaculture Stewardship Council) for farmed seafood. They also participate in Fishery Improvement Projects (FIPs), implement traceability systems, and align sourcing policies with regional fisheries management plans."
