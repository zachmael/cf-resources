...
faqs:
  - question: "What is ESG reporting?"
    answer: "ESG reporting is the disclosure of a company's environmental, social, and governance performance to stakeholders. It encompasses climate emissions, resource use, labor practices, diversity, governance structures, and more, typically following frameworks like GRI, SASB, ISSB, or CSRD/ESRS."
  - question: "Is ESG reporting mandatory?"
    answer: "Increasingly, yes. The EU's CSRD mandates ESG reporting for large companies using ESRS standards. California requires climate disclosure from large companies operating in the state. The ISSB standards are being adopted globally. Even where not mandatory, investor and customer pressure makes ESG reporting effectively required for large companies."
  - question: "What is the difference between the major ESG reporting frameworks?"
    answer: "GRI focuses on a company's impacts on the world (impact materiality). ISSB/SASB focuses on sustainability issues affecting company value (financial materiality). CSRD/ESRS combines both (double materiality). CDP specializes in environmental disclosure. TCFD/TNFD focus specifically on climate and nature-related financial risks."
