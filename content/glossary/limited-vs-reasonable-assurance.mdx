...
faqs:
  - question: "What is the difference between limited and reasonable assurance?"
    answer: "Limited assurance provides a moderate level of confidence that reported information is free from material misstatement — the auditor states nothing came to their attention indicating errors. Reasonable assurance provides a high level of confidence through more extensive testing — similar to a financial audit."
  - question: "Which type of assurance is required for sustainability reporting?"
    answer: "Most current sustainability reporting regulations start with limited assurance requirements, with plans to transition to reasonable assurance over time. The CSRD begins with limited assurance for ESRS reports, with a planned move to reasonable assurance. The SEC climate rule also contemplated limited assurance initially."
  - question: "Why does the assurance level matter?"
    answer: "Reasonable assurance requires significantly more audit work and cost (roughly 30-50% more than limited), but provides greater confidence to stakeholders. As sustainability data increasingly informs investment decisions and regulatory compliance, the push toward reasonable assurance reflects the growing importance of ESG data reliability."
