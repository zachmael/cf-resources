...
faqs:
  - question: "What is carbon insetting?"
    answer: "Carbon insetting is investing in emission reduction or carbon removal projects within a company's own value chain, rather than purchasing offsets from unrelated external projects. Examples include funding agroforestry on supplier farms or renewable energy in manufacturing communities."
  - question: "How is carbon insetting different from carbon offsetting?"
    answer: "Offsets compensate for emissions through external projects with no connection to the company's operations. Insets reduce emissions within the company's own supply chain, creating both climate benefits and business value through stronger supplier relationships, supply chain resilience, and more credible emissions reductions."
  - question: "Why are companies shifting toward carbon insetting?"
    answer: "Insetting addresses growing skepticism about offset quality and greenwashing risk. It produces Scope 3 emission reductions that directly improve a company's carbon inventory, strengthens supply chain partnerships, and is viewed more favorably by ESG rating agencies and disclosure frameworks."
