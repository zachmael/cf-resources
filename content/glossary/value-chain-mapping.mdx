...
faqs:
  - question: "What is value chain mapping?"
    answer: "Value chain mapping is the process of identifying and documenting all activities, relationships, and flows involved in creating and delivering a product or service — from raw materials through end-of-life. In the sustainability context, it identifies where ESG risks, emissions hotspots, and impact opportunities exist across the chain."
  - question: "Why is value chain mapping essential for ESG?"
    answer: "Most of a company's environmental and social impact occurs outside its direct operations — in supply chains and product use. Without mapping the value chain, companies cannot accurately measure Scope 3 emissions, identify human rights risks, or comply with due diligence regulations like CS3D and EUDR."
  - question: "How deep should value chain mapping go?"
    answer: "Ideally, mapping should extend to raw material origins (Tier N), but practical constraints limit most companies to Tier 1-3 suppliers. Risk-based approaches focus deep mapping on high-risk commodities and regions. Technology platforms, satellite monitoring, and industry data-sharing initiatives are helping companies see further into their supply chains."
