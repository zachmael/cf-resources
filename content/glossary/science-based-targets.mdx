...
faqs:
  - question: "What are science-based targets?"
    answer: "Science-based targets are corporate emission reduction goals aligned with the level of decarbonization required to meet the Paris Agreement temperature goals. The Science Based Targets initiative (SBTi) validates targets against climate science, currently requiring alignment with a 1.5°C pathway."
  - question: "How many companies have science-based targets?"
    answer: "Over 7,000 companies have committed to SBTi targets as of 2025, including nearly half of global market capitalization. Targets cover near-term (5-10 year) emission reductions for Scopes 1, 2, and often Scope 3, plus long-term net-zero commitments requiring 90%+ emission reductions."
  - question: "What do science-based targets require?"
    answer: "Near-term targets must reduce Scope 1 and 2 emissions by at least 4.2% per year. Companies with significant Scope 3 emissions must set Scope 3 targets covering at least 67% of value chain emissions. Net-zero targets require at least 90% absolute reduction before using carbon removals for residual emissions."
