...
faqs:
  - question: "What is single materiality?"
    answer: "Single materiality assesses sustainability issues only through the lens of their effect on a company's financial performance and enterprise value. It answers: 'Does this ESG issue affect our business financially?' This is the approach used by the ISSB, SASB, and the TCFD."
  - question: "How does single materiality differ from double materiality?"
    answer: "Single materiality focuses only on financial impacts to the company (outside-in). Double materiality adds impact materiality — the company's effects on people and the environment (inside-out) — regardless of whether those impacts create financial risk. The EU uses double materiality; the ISSB uses single materiality."
  - question: "Is single materiality sufficient?"
    answer: "It depends on the purpose. For investor-focused disclosure, single materiality captures financially relevant ESG risks. Critics argue it misses significant impacts on society and environment that may not yet affect financial statements but are important to other stakeholders — and may become financially material over time."
