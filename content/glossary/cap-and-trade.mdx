...
faqs:
  - question: "What is cap-and-trade?"
    answer: "Cap-and-trade is a market-based emissions reduction system where a government sets a cap on total emissions, issues or auctions emission allowances, and allows companies to trade them. Companies that reduce emissions below their allocation can sell surplus allowances to those that exceed theirs."
  - question: "What are the major cap-and-trade systems?"
    answer: "The EU Emissions Trading System (EU ETS) is the largest, covering about 40% of EU greenhouse gas emissions. Other major systems include California's cap-and-trade program, the Regional Greenhouse Gas Initiative (RGGI) in northeastern US states, China's national ETS, and South Korea's K-ETS."
  - question: "How does cap-and-trade affect businesses?"
    answer: "Companies covered by cap-and-trade must either reduce their emissions or purchase allowances, creating a direct cost for carbon pollution. This incentivizes investment in cleaner technologies and energy efficiency. Carbon allowance prices become a material cost factor in capital allocation and operational decisions."
