...
faqs:
  - question: "What are nationally determined contributions?"
    answer: "Nationally determined contributions (NDCs) are each country's self-defined climate action pledges under the Paris Agreement. They outline emission reduction targets, adaptation plans, and implementation strategies. Countries must submit updated NDCs every five years, with each successive NDC expected to be more ambitious."
  - question: "Are current NDCs sufficient to meet climate targets?"
    answer: "No. The UNEP Emissions Gap Report consistently shows that current NDCs, even if fully implemented, would lead to roughly 2.5-2.9°C of warming by 2100 — well above the Paris Agreement's 1.5°C target. The gap between pledges and required action remains substantial."
  - question: "How do NDCs affect businesses?"
    answer: "NDCs signal future regulatory direction — companies can anticipate carbon pricing, renewable energy mandates, efficiency standards, and sector-specific regulations based on their country's NDC. Companies operating across borders must track multiple NDCs to understand the policy landscape in each market."
