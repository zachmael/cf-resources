...
faqs:
  - question: "What is ocean acidification?"
    answer: "Ocean acidification is the ongoing decrease in ocean pH caused by absorption of atmospheric CO2. The ocean has absorbed roughly 30% of human-caused CO2 emissions, increasing acidity by about 30% since the Industrial Revolution. This threatens marine organisms that build shells or skeletons from calcium carbonate."
  - question: "Which industries are most affected by ocean acidification?"
    answer: "Shellfish aquaculture, wild-catch fisheries, and coastal tourism are directly threatened. The US shellfish industry alone is valued at lastUpdated:+ billion annually. Coral reef degradation from acidification threatens the $36 billion global reef tourism industry. Food and beverage companies with seafood supply chains face input risks."
  - question: "Can ocean acidification be reversed?"
    answer: "Ocean acidification can only be reversed by reducing atmospheric CO2 concentrations. There is no viable large-scale treatment for ocean chemistry. Some local interventions (ocean alkalinity enhancement) are being researched but remain experimental. Reducing CO2 emissions is the only effective long-term solution."
