...
faqs:
  - question: "What are the GRI Standards?"
    answer: "The Global Reporting Initiative (GRI) Standards are the most widely used sustainability reporting framework globally. They provide a modular system of standards for reporting on economic, environmental, and social impacts. Over 10,000 organizations in 100+ countries use GRI for sustainability reporting."
  - question: "How do GRI Standards differ from ISSB?"
    answer: "GRI focuses on a company's impacts on the economy, environment, and people (impact materiality). ISSB focuses on sustainability matters that affect enterprise value (financial materiality). GRI serves a broader stakeholder audience; ISSB primarily serves investors. Many companies report using both frameworks."
  - question: "Are GRI Standards mandatory?"
    answer: "GRI Standards are voluntary but widely adopted. The EU's ESRS standards (mandatory under CSRD) were developed in collaboration with GRI and share significant overlap. Some jurisdictions reference GRI in their reporting requirements. For many companies, GRI reporting is expected by stakeholders even where not legally required."
