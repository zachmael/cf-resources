...
faqs:
  - question: "What is the ISSB?"
    answer: "The International Sustainability Standards Board (ISSB) is a standard-setting body under the IFRS Foundation that develops global baseline sustainability disclosure standards for capital markets. It issued its first standards — IFRS S1 and S2 — in June 2023, focusing on general sustainability and climate-related disclosures."
  - question: "How does the ISSB relate to other frameworks?"
    answer: "The ISSB consolidated the work of TCFD, SASB, IIRC, and CDSB. TCFD recommendations are fully incorporated into IFRS S2. SASB's industry-specific metrics inform the ISSB's sector guidance. The goal is to create a global baseline that jurisdictions can adopt or build upon."
  - question: "Is the ISSB mandatory?"
    answer: "The ISSB standards themselves are voluntary, but jurisdictions are adopting them into local requirements. The UK, Japan, Singapore, Australia, Canada, and others have announced plans to require or reference ISSB standards. Where adopted, compliance becomes mandatory for covered companies."
