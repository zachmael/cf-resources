...
faqs:
  - question: "What is the EU Green Deal?"
    answer: "The European Green Deal is the EU's plan to become climate-neutral by 2050 while decoupling economic growth from resource use. Launched in 2019, it drives policy across energy, transport, agriculture, industry, and finance — generating regulations like the CSRD, EU Taxonomy, CBAM, and EUDR."
  - question: "How does the EU Green Deal affect businesses?"
    answer: "The Green Deal creates a web of regulations that affect virtually every sector. Companies face new reporting requirements (CSRD/ESRS), supply chain due diligence obligations, carbon pricing (EU ETS, CBAM), sustainable finance disclosure requirements, and product sustainability standards. Non-EU companies selling into the EU are also affected."
  - question: "Is the EU Green Deal being scaled back?"
    answer: "The 2025-2026 Omnibus simplification packages have reduced the scope and burden of some Green Deal regulations, particularly the CSRD and CS3D. However, the core ambition — climate neutrality by 2050 — remains law under the European Climate Law. The trajectory is toward simplification of implementation, not abandonment of goals."
