...
faqs:
  - question: "What is global warming potential?"
    answer: "Global warming potential (GWP) is a measure of how much heat a greenhouse gas traps in the atmosphere over a specified time period, relative to CO2. For example, methane has a GWP of 80 over 20 years and 28 over 100 years, meaning one ton of methane traps 28 times more heat than one ton of CO2 over a century."
  - question: "Why does the time horizon matter for GWP?"
    answer: "Different time horizons change relative impact significantly. Methane is potent but short-lived (about 12 years), so its 20-year GWP (80) is much higher than its 100-year GWP (28). The choice of time horizon affects policy priorities — using GWP-20 emphasizes the urgency of reducing short-lived climate pollutants."
  - question: "How is GWP used in carbon accounting?"
    answer: "GWP converts all greenhouse gas emissions into CO2-equivalent (CO2e), allowing different gases to be compared and aggregated. The GHG Protocol and most reporting frameworks use 100-year GWP values from the IPCC. This standardization enables companies to report a single total emissions figure across all greenhouse gases."
