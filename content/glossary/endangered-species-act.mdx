...
faqs:
  - question: "What is the Endangered Species Act?"
    answer: "The Endangered Species Act (ESA) is a 1973 US federal law that protects species at risk of extinction and the ecosystems on which they depend. It prohibits the 'take' of listed species and requires federal agencies to ensure their actions do not jeopardize listed species or destroy critical habitat."
  - question: "How does the ESA affect businesses?"
    answer: "Companies with operations that may affect listed species or critical habitat must obtain permits and often implement mitigation measures. The ESA can affect land development, infrastructure projects, water management, forestry, mining, and agriculture. Non-compliance carries civil and criminal penalties."
  - question: "How many species are protected under the ESA?"
    answer: "Over 1,600 species are currently listed as endangered or threatened under the ESA in the United States. The Fish and Wildlife Service and NOAA Fisheries manage listings and recovery plans. The ESA has prevented the extinction of 99% of listed species, though full recovery remains slow."
