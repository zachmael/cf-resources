...
faqs:
  - question: "What are combined sewer overflows?"
    answer: "Combined sewer overflows (CSOs) occur when a combined sewer system — one that carries both sewage and stormwater — exceeds capacity during heavy rainfall and discharges untreated wastewater directly into rivers, lakes, or coastal waters."
  - question: "Why are CSOs getting worse?"
    answer: "Climate change is increasing the frequency and intensity of heavy rainfall events, causing more frequent CSO discharges. Aging infrastructure, urban expansion, and increasing impervious surfaces compound the problem. Many combined sewer systems were designed for historical rainfall patterns that no longer apply."
  - question: "How do CSOs relate to corporate water risk?"
    answer: "Companies drawing water from or discharging into waterways affected by CSOs face water quality risks, regulatory restrictions, and potential liability. Food and beverage companies, water utilities, and real estate developers in cities with combined systems should assess CSO exposure as part of water stewardship strategies."
