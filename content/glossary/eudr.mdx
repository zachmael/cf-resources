...
faqs:
  - question: "What is the EUDR?"
    answer: "The EU Deforestation Regulation (EUDR) requires companies placing cattle, cocoa, coffee, oil palm, rubber, soya, and wood (and derived products) on the EU market to prove these commodities were not produced on land deforested after December 31, 2020."
  - question: "When does the EUDR take effect?"
    answer: "The EUDR was adopted in 2023 with an original application date of December 2024 for large companies. Implementation has been delayed to allow more preparation time. Companies must establish due diligence systems with geolocation data for all production plots, risk assessment, and risk mitigation measures."
  - question: "How does the EUDR affect global supply chains?"
    answer: "The EUDR affects any company in the supply chain of covered commodities entering the EU market, regardless of where they are headquartered. Suppliers worldwide must provide geolocation coordinates for production plots, and due diligence must verify deforestation-free status using satellite monitoring and third-party verification."
