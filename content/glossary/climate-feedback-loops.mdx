...
faqs:
  - question: "What are climate feedback loops?"
    answer: "Climate feedback loops are self-reinforcing cycles where an initial warming trigger sets off changes that amplify further warming (positive feedback) or dampen it (negative feedback). Examples include ice-albedo feedback, permafrost thawing, and water vapor amplification."
  - question: "What are the most dangerous climate feedback loops?"
    answer: "The most concerning positive feedbacks include permafrost thawing (releasing stored methane and CO2), Amazon rainforest dieback (converting a carbon sink to a source), ice sheet collapse (reducing reflective surface area), and methane release from ocean sediments. These could accelerate warming beyond human control."
  - question: "How do feedback loops affect climate projections?"
    answer: "Feedback loops create uncertainty in climate models and the potential for non-linear, rapid temperature increases. Some feedbacks are not yet fully incorporated into mainstream projections, meaning actual warming could exceed model predictions. This is why tipping points are a major concern for risk assessment."
