...
faqs:
  - question: "What are green bonds?"
    answer: "Green bonds are fixed-income instruments where proceeds are exclusively used to finance or refinance projects with environmental benefits — such as renewable energy, energy efficiency, clean transport, sustainable water management, or pollution prevention. They follow principles like the ICMA Green Bond Principles."
  - question: "How big is the green bond market?"
    answer: "Annual green bond issuance exceeded $500 billion in 2023, with cumulative issuance surpassing $2.5 trillion since inception. Issuers include governments, municipalities, development banks, and corporations. The EU Green Bond Standard (effective 2024) sets stricter requirements for bonds labeled 'green' in the EU."
  - question: "Do green bonds offer better returns?"
    answer: "Green bonds often price at a slight premium (the 'greenium'), meaning investors accept marginally lower yields. The greenium is typically 2-5 basis points for investment-grade issuances. For issuers, the benefits include access to dedicated ESG capital pools, diversified investor base, and reputational value."
