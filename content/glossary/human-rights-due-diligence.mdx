...
faqs:
  - question: "What is human rights due diligence?"
    answer: "Human rights due diligence (HRDD) is the ongoing process by which companies identify, prevent, mitigate, and account for how they address their adverse human rights impacts. It follows the UN Guiding Principles on Business and Human Rights and covers both direct operations and value chain relationships."
  - question: "Is human rights due diligence mandatory?"
    answer: "Increasingly, yes. France's Duty of Vigilance Law (2017), Germany's Supply Chain Act (2023), Norway's Transparency Act, and the EU's Corporate Sustainability Due Diligence Directive (CS3D) all mandate some form of HRDD. Additional national laws are in development across Europe and beyond."
  - question: "What does HRDD require companies to do?"
    answer: "Companies must identify salient human rights risks in their operations and value chains, assess actual and potential impacts, integrate findings into decision-making, track effectiveness of responses, communicate how impacts are addressed, and provide or enable remediation when harms occur."
