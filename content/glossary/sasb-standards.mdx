...
faqs:
  - question: "What are the SASB Standards?"
    answer: "The Sustainability Accounting Standards Board (SASB) Standards identify financially material sustainability topics and metrics for 77 industries. They focus on industry-specific ESG issues most likely to affect financial performance, providing investors with comparable, decision-useful sustainability data."
  - question: "How do SASB Standards relate to the ISSB?"
    answer: "SASB was consolidated into the IFRS Foundation in 2022 and now underpins the ISSB's industry-specific guidance. SASB Standards inform which sustainability topics are financially material for each industry under IFRS S1. Companies already reporting under SASB are well-positioned for ISSB compliance."
  - question: "How many industries do SASB Standards cover?"
    answer: "SASB covers 77 industries across 11 sectors, with each industry standard identifying 5-15 disclosure topics and associated metrics. For example, the technology sector covers data privacy, energy management, and supply chain labor standards, while the oil and gas sector covers emissions, water, and community relations."
