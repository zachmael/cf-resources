...
faqs:
  - question: "What is the main difference between SBTi and Net?"
    answer: "If your organization is early-stage—perhaps you haven't completed a comprehensive GHG inventory—a well-structured net-zero pledge can serve as a directional commitment while you build the analytical foundation for SBTi validation."
  - question: "Which should my organization use — SBTi or Net?"
    answer: "It provides a framework, criteria, and independent validation for corporate emission reduction targets that align with the goals of the Paris Agreement—specifically limiting global warming to 1."
  - question: "Can an organization comply with both SBTi and Net?"
    answer: "Both targets undergo independent validation against sector-specific decarbonization pathways."
---
