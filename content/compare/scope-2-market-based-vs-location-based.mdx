...
faqs:
  - question: "What is the main difference between Scope 2 Market-Based and Location?"
    answer: "Stakeholders increasingly scrutinize both numbers, and companies that report only a market-based zero while operating on coal-heavy grids face credibility questions."
  - question: "Which should my organization use — Scope 2 Market-Based or Location?"
    answer: "Every organization that consumes grid electricity can calculate a location-based figure."
  - question: "Can an organization comply with both Scope 2 Market-Based and Location?"
    answer: "If a company uses the market-based method, both figures must appear."
---
