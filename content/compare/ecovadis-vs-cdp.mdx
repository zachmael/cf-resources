...
faqs:
  - question: "What is the main difference between EcoVadis and CDP?"
    answer: "This difference affects adoption dynamics: EcoVadis assessments are typically triggered by buyer requests that justify the cost, while CDP disclosure can be initiated without financial commitment."
  - question: "Which should my organization use — EcoVadis or CDP?"
    answer: "The platform was designed specifically for supply chain sustainability management—helping buying organizations evaluate and monitor the ESG performance of their suppliers."
  - question: "Can an organization comply with both EcoVadis and CDP?"
    answer: "Many companies end up doing both."
---
