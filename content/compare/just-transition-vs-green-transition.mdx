...
faqs:
  - question: "What is the main difference between Just Transition and Green Transition?"
    answer: "While fossil fuel workers are the most visible constituency, just transition principles apply to anyone negatively affected by decarbonization."
  - question: "Which should my organization use — Just Transition or Green Transition?"
    answer: "The just transition requires labor ministries, social welfare agencies, community development organizations, and affected workers themselves to have a seat at the table."
  - question: "Can an organization comply with both Just Transition and Green Transition?"
    answer: "The just transition serves specific populations: coal miners in Appalachia, oil workers in Alberta, frontline communities in the Global South, Indigenous peoples whose lands host both fossil fuel and renewable energy infrastructure."
---
