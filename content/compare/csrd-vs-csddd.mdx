...
faqs:
  - question: "What is the main difference between CSRD and CSDDD?"
    answer: "Unlike the CSRD, which mandates what companies disclose, the CSDDD mandates what companies do — they must identify, prevent, mitigate, and account for adverse human rights and environmental impacts."
  - question: "Which should my organization use — CSRD or CSDDD?"
    answer: "Organizations that implement robust CSDDD due diligence will find CSRD social disclosures straightforward to prepare."
  - question: "Can an organization comply with both CSRD and CSDDD?"
    answer: "Both directives address the value chain, but differently."
---
