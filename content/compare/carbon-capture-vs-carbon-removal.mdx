...
faqs:
  - question: "What is the main difference between Carbon Capture and Carbon Removal?"
    answer: "Unlike carbon capture, which intercepts emissions at source, CDR addresses the stock of CO₂ already accumulated in the atmosphere."
  - question: "Which should my organization use — Carbon Capture or Carbon Removal?"
    answer: "CCS costs range from $15-120/tonne depending on the CO₂ concentration and application."
  - question: "Can an organization comply with both Carbon Capture and Carbon Removal?"
    answer: "Both are necessary: CCS for emissions that can't be eliminated (cement process emissions, for instance), CDR for neutralizing residual emissions and eventually drawing down historical accumulations."
---
