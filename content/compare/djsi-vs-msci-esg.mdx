...
faqs:
  - question: "What is the main difference between DJSI and MSCI ESG?"
    answer: "This distinction means DJSI is binary (in or out), while MSCI ESG is continuous (seven grades of differentiation)."
  - question: "Which should my organization use — DJSI or MSCI ESG?"
    answer: "The top-scoring companies in each industry—typically the top 10-20% depending on the index—earn inclusion."
  - question: "Can an organization comply with both DJSI and MSCI ESG?"
    answer: "An investor can distinguish between an MSCI AAA company and an A company, both of which might qualify for DJSI inclusion."
---
