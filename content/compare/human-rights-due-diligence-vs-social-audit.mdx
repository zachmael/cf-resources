...
faqs:
  - question: "What is the main difference between Human Rights Due Diligence and Social Audit?"
    answer: "Human Rights Due Diligence and Social Audit differ in scope, methodology, and intended audience. Human rights due diligence and social audits are both tools for supply chain accountability, but they work very differently."
  - question: "Which should my organization use — Human Rights Due Diligence or Social Audit?"
    answer: "Under the UNGPs, all businesses have a responsibility to respect human rights—independent of state obligations—and HRDD is the mechanism for meeting that responsibility."
  - question: "Can an organization comply with both Human Rights Due Diligence and Social Audit?"
    answer: "This is why anti-trafficking experts increasingly advocate for worker-driven monitoring as a complement to auditing."
---
