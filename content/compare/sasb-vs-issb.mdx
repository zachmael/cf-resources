...
faqs:
  - question: "What is the main difference between SASB and ISSB?"
    answer: "SASB and ISSB differ in scope, methodology, and intended audience. Compare SASB Standards and ISSB (IFRS S1/S2) — how SASB's industry metrics feed into the ISSB framework and what the consolidation means for reporters."
  - question: "Which should my organization use — SASB or ISSB?"
    answer: "Both standards incorporate SASB's industry-specific approach — IFRS S1 directs entities to consider SASB Standards when identifying relevant sustainability topics and metrics, and IFRS S2 includes industry-based climate metrics derived from SASB."
  - question: "Can an organization comply with both SASB and ISSB?"
    answer: "Both standards incorporate SASB's industry-specific approach — IFRS S1 directs entities to consider SASB Standards when identifying relevant sustainability topics and metrics, and IFRS S2 includes industry-based climate metrics derived from SASB."
---
