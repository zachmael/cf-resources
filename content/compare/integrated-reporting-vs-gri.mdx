...
faqs:
  - question: "What is the main difference between Integrated Reporting and GRI?"
    answer: "Integrated Reporting primarily targets providers of financial capital — investors, lenders — while acknowledging value for other stakeholders."
  - question: "Which should my organization use — Integrated Reporting or GRI?"
    answer: "The International Integrated Reporting Framework, originally developed by the International Integrated Reporting Council (IIRC), provides principles for organizations to communicate how they create, preserve, or erode value over time."
  - question: "Can an organization comply with both Integrated Reporting and GRI?"
    answer: "Use both if you're a large organization that needs to communicate with both investor and multi-stakeholder audiences."
---
