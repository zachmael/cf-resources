...
faqs:
  - question: "What is the main difference between GRI and SASB?"
    answer: "This difference in audience drives fundamentally different disclosure content, even when both frameworks address the same topic."
  - question: "Which should my organization use — GRI or SASB?"
    answer: "Organizations that have been reporting under both are well-positioned for emerging regulatory requirements that demand consideration of both impact and financial materiality."
  - question: "Can an organization comply with both GRI and SASB?"
    answer: "This difference in audience drives fundamentally different disclosure content, even when both frameworks address the same topic."
---
