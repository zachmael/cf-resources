...
faqs:
  - question: "What is the main difference between ESRS and GRI?"
    answer: "The most significant conceptual difference."
  - question: "Which should my organization use — ESRS or GRI?"
    answer: "GRI reporting is voluntary — organizations choose to report and self-declare their level of conformance."
  - question: "Can an organization comply with both ESRS and GRI?"
    answer: "ESRS requires double materiality: both impact materiality (aligned with GRI) and financial materiality (how sustainability issues affect the company's financial position)."
---
