...
faqs:
  - question: "What is the main difference between CDP and TCFD?"
    answer: "While TCFD as an independent body no longer exists, its four-pillar architecture remains the structural foundation for global climate disclosure through ISSB, ESRS, and CDP."
  - question: "Which should my organization use — CDP or TCFD?"
    answer: "Organizations that treated CDP seriously produced better TCFD disclosures than those that attempted TCFD reporting independently."
  - question: "Can an organization comply with both CDP and TCFD?"
    answer: "While the climate overlap is significant, CDP's water and forests questionnaires extend into environmental territory that TCFD never covered."
---
