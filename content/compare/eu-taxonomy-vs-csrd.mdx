...
faqs:
  - question: "What is the main difference between EU Taxonomy and CSRD?"
    answer: "ESRS disclosure requirements, while prescriptive, involve more judgment in materiality assessment and narrative disclosures."
  - question: "Which should my organization use — EU Taxonomy or CSRD?"
    answer: "A company might have some Taxonomy-aligned activities and some not; the CSRD assesses the entire organization."
  - question: "Can an organization comply with both EU Taxonomy and CSRD?"
    answer: "Critically, the CSRD and the EU Taxonomy are not alternatives — they are complementary components of the EU's sustainable finance architecture."
---
