...
faqs:
  - question: "What is the main difference between TCFD and ISSB?"
    answer: "While IFRS S2 is the only topical standard issued so far, the ISSB is researching additional topics including biodiversity and human capital."
  - question: "Which should my organization use — TCFD or ISSB?"
    answer: "Organizations in the transition period may choose to reference both frameworks."
  - question: "Can an organization comply with both TCFD and ISSB?"
    answer: "Both frameworks address climate scenario analysis."
---
