...
faqs:
  - question: "What is the main difference between Biodiversity Net Gain and Biodiversity Offsets?"
    answer: "The key difference is that BNG sets the outcome target (10% net gain) while offsets are a delivery mechanism."
  - question: "Which should my organization use — Biodiversity Net Gain or Biodiversity Offsets?"
    answer: "BNG's integration into routine planning creates universal coverage; offset requirements depend on impact significance thresholds."
  - question: "Can an organization comply with both Biodiversity Net Gain and Biodiversity Offsets?"
    answer: "Both nominally follow the mitigation hierarchy (avoid, minimize, restore, offset), but BNG's metric-based system explicitly rewards avoidance and on-site delivery through the unit calculation."
---
