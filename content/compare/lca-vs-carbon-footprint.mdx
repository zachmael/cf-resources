...
faqs:
  - question: "What is the main difference between LCA and Carbon Footprint?"
    answer: "The accessibility difference drives adoption patterns."
  - question: "Which should my organization use — LCA or Carbon Footprint?"
    answer: "A full LCA for a complex product can take 3-12 months and cost $50,000-200,000+, depending on the product system's complexity and data availability."
  - question: "Can an organization comply with both LCA and Carbon Footprint?"
    answer: "Both require life cycle inventory data, but LCA needs data for all environmental flows (emissions to air, water, soil; resource consumption; land use)."
---
