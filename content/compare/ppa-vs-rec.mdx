...
faqs:
  - question: "What is the main difference between PPA and REC?"
    answer: "Virtual (or financial) PPAs are contracts for differences—the buyer and generator agree on a strike price, and the buyer receives the RECs while the generator sells electricity into the wholesale market."
  - question: "Which should my organization use — PPA or REC?"
    answer: "The best strategy for most large organizations is a portfolio approach: PPAs for the majority of consumption in key markets, supplemented by RECs for smaller or harder-to-reach operations."
  - question: "Can an organization comply with both PPA and REC?"
    answer: "Physical PPAs deliver electricity directly to the buyer through the grid, with the buyer receiving both the energy and the associated RECs."
---
