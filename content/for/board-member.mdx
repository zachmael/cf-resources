...
faqs:
  - question: "What should a Board Member know about sustainability reporting?"
    answer: "CSRD requires that administrative, management, and supervisory bodies are collectively responsible for ensuring compliance with sustainability reporting requirements."
  - question: "What are the top sustainability priorities for a Board Member?"
    answer: "Directors must now demonstrate competence on climate risk, transition planning, supply chain due diligence, biodiversity impacts, and social metrics — topics that were barely discussed in boardrooms five years ago."
  - question: "What quick wins can a Board Member achieve on sustainability?"
    answer: "Quick wins include auditing existing data for sustainability-relevant metrics, identifying reporting gaps, and establishing regular communication with the sustainability team to align on near-term deliverables."
---
