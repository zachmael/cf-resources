...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return { title: item.meta.title, description: item.meta.description, alternates: { canonical: `/how-to/${params.slug}` }, other: { 'last-modified': lu } };
}
...
export default async function HowToPage({ params }: Props) {
  ...
  return <SectionPage meta={item.meta} rendered={rendered} rawContent={item.content} section="how-to" sectionLabel="How-To" sectionHref="/how-to" />;
}
