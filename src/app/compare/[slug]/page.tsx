...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title: item.meta.title, description: item.meta.description, url: `https://resources.councilfire.org/compare/${params.slug}`, type: 'article', siteName: 'Council Fire Resources' },
...
export default async function ComparePage({ params }: Props) {
  ...
  return <SectionPage meta={item.meta} rendered={rendered} rawContent={item.content} section="compare" sectionLabel="Comparisons" sectionHref="/compare" />;
}
