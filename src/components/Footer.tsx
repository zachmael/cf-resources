        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex gap-3 mt-5">
              <a href="https://www.linkedin.com/company/council-fire/" aria-label="LinkedIn" className="flex items-center justify-center w-9 h-9 rounded-full bg-white/10 text-gray-400 hover:bg-teal-500 hover:text-white transition-all">
